...
#NOTE:
#If the required packages are already installed then run the code as it is otherwise,
...
# Splitting data to 50% training data and 50% testing data 
split=sample.split(final_dataset, SplitRatio=0.5)
...
x <- final_dataset$Alcohol
y <- final_dataset$Life.expectancy
